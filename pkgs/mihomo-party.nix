...
in
  stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      rm opt/mihomo-party/resources/sidecar/mihomo
      echo -e '#!/bin/bash\n exec /run/wrappers/bin/mihomo "$@"' > opt/mihomo-party/resources/sidecar/mihomo
      chmod +x opt/mihomo-party/resources/sidecar/mihomo
